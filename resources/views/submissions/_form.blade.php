...
<div class="form-group" id="div_content_type">
    <label class="col-sm-3 control-label" for="content_type">Content Type: </label>
    <div class="col-sm-9">
        <label class="radio-inline">
            <input type="radio" name="content_type" value="PL" checked="true" required>PL
        </label>
        <label class="radio-inline">
            <input type="radio" name="content_type" value="VD">VD
        </label>
    </div>
</div>

<div class="form-group" id="div_label_name">
    <label class="col-sm-3 control-label" for="label_name">Label Name: </label>
    <div class="col-sm-9">
        <input class="form-control" type="text" name="label_name" id="label_name" size="50" value="" required>
    </div>
</div>
...
<div class="form-group" id="div_upc_ean">
    ...
    <div class="col-sm-9">
        ...
        <div class="alert alert-danger" role="alert" id="invalid">The UPC/EAN must contain only numbers and be 12 or 13
            integers in length.
        </div>
    </div>
</div>
...
<div class="form-group" id="div_storedate">
    ...
    <div class="col-sm-9" id="datepicker">
        ...
        <div class="alert alert-success" role="alert" id="valid_date">Congratulatons! Don't forget to plan your release
            party!
        </div>
...
<div class="form-group" id="div_marketshare">
    ...
    <div class="col-sm-9">
        <div class="input-group">
            ...
            <input class="form-control" type="number" min="1" max="100" name="marketshare" id="marketshare"
...
<div class="form-group" id="div_itunes_forecast">
    ...
    <div class="col-sm-9">
        <div class="input-group">
            <div class="input-group-addon">$</div>
            <input class="form-control" type="number" name="itunes_forecast" id="itunes_forecast" placeholder="100"
                   required>
            <div class="input-group-addon">.00</div>
        </div>
        <span class="help-block"> *required for any title being pitched for featuring on Main/Music Main</span>
...
<div class="form-group" id="div_release_sales">
    ...
    <div class="col-sm-9">
        <div class="input-group">
            <div class="input-group-addon">$</div>
            <input class="form-control" type="number" name="release_sales" id="release_sales" placeholder="100"
                   required>
            <div class="input-group-addon">.00</div>
        </div>
    </div>
...
<div class="form-group" id="div_sales_history">
    ...
    <div class="col-sm-9">
                <textarea class="form-control" type="text" name="sales_history" id="sales_history" rows="10" cols="110"
                          spellcheck="true" maxlength="500"
                          placeholder="Last album Week 1 iTunes Sales: 5,000. LTD last two albums: Album 1: 30,000, 16% share, released 2008, Album 2: 45,000, 20% share, released 2010"
                          required></textarea>
...
<div class="form-group" id="div_development_cost">
    ...
    <div class="col-sm-9">
        <div class="input-group">
            <div class="input-group-addon">$</div>
            <input class="form-control" type="number" name="development_cost" id="development_cost" placeholder="100"
                   required>
            <div class="input-group-addon">.00</div>
        </div>
    </div>
...
<div class="form-group" id="div_description">
    ...
    <div class="col-sm-9">
                <textarea class="form-control" type="text" name="description" id="description" rows="10" cols="110"
                          spellcheck="true" maxlength="500"
                          placeholder="*Brief* Album Description + key facts (Top 10 CHR, GMA/Ellen performances street week, tour begins in August, etc.)"
                          required></textarea>
    </div>
</div>
...
<div class="form-group" id="div_marketing_drivers">
    ...
    <div class="col-sm-9">
                <textarea class="form-control" type="text" name="marketing_drivers" id="marketing_drivers" rows="10"
                          cols="110" spellcheck="true" maxlength="500"
                          placeholder="For EDITORIALLY supported releases, please outline any significant iTunes-specific marketing: Dedicated e-mail blast to 'X' # of fans, $xx key word buy, exclusive banner campaign, radio/TV spot tagging in 'X' key markets, print ad(s) with exclusive tag using iTunes custom URL, in-theater ad tagging, TV or radio on-air mentions either via voiceover or chyron, iTunes 360 participation, etc."
                          required></textarea>
    </div>
</div>
